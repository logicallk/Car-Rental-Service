    ...
    <nav class="navbar navbar-expand-lg text-light  sticky-top navbar-light p-3 shadow-sm"
        ...
        <div class="container-fluid text-white">
            ...
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item">
                        <a class="nav-link mx-2 text-uppercase text-white" href="Cart.html">
                            <i class="bi bi-cart"></i> Cart</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 text-uppercase text-white" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Name: Digvijay Pawar Email: digvijay2263p@gmail.com">
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-5 justify-content-between">
                            <img src="./src/8453874-removebg-preview.png " class="img-fluid w-60 h-75" alt="">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-8 bg-white px-5 pt-3" id="products">
                <div class="container">
                    ...
                    <hr>
                    <%List<Vehicle> vehicles=(List<Vehicle>)request.getAttribute("fiteredlist") ;
                     for(Vehicle v: vehicles)
                     {
                    %>
                    <div class="row border">
                        <div class="col-3 p-0">
                            <img src="https://stimg.cardekho.com/images/carexteriorimages/630x420/Maruti/Alto-800/10327/1687348176706/front-left-side-47.jpg?impolicy=resize&imwidth=220" class="img-fluid h-100 w-100" alt="">
                        </div>
                        
                        <div class="col-6 p-3 border-end border-start justify-content-between align-items-center">
                            <h5><b>Maruti Suzuki Alto 800</b></h5>
                            <p class="lead">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi sint, maxime ea assumenda inventore reprehenderit similique deleniti ad quaerat amet!   
                            </p>
                            <a href="" class="btn btn-light btn-sm border">> Read more</a>
                        </div>
                        <div class="col-3 text-center">
                            <span style="font-size: xx-large;"><b>Rs. 100</span>
                                <p class="text-muted">per hour</p>
                            <a href="addRequest" class="btn btn-dark btn-lg mt-3">Book Now</a>
