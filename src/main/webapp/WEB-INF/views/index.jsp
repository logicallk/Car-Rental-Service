    ...
    <nav class="navbar navbar-expand-lg custom_nav-container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link nav-link-section" href="#"><i class="fas fa-info-circle"></i> About</a>
          </li>
          <li class="nav-item active">
            <a class="nav-link nav-link-section" href="login"> <i class="fas fa-sign-in-alt"></i> Login</a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 info-col">
          <div class="info_detail">
            ...
            <p>
              Embark on thrilling journeys with adventurous tales that promise excitement on every page. Welcome
              to a sanctuary of knowledge and storytelling, where the magic of books comes to life.
            </p>
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">The Weekend Ride</a>
      </p>
    </div>
  </footer>
  <!-- End Footer Section -->
